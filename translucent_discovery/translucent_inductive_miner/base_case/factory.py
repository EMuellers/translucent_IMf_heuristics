...
from translucent_discovery.translucent_inductive_miner.base_case.empty_log import EmptyLogBaseCaseTranslucent
from translucent_discovery.translucent_inductive_miner.base_case.single_activity import SingleActivityBaseCaseTranslucent
...
class BaseCaseFactory: # All Base Cases perform checks on UVCL, but should be fine as we don't need to project any logs
    ...
    def get_base_cases(cls, obj: T, inst: IMInstance, parameters: Optional[Dict[str, Any]] = None) -> List[S]:
        return [EmptyLogBaseCaseTranslucent, SingleActivityBaseCaseTranslucent]
