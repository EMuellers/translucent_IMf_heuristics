...
class ActivityConcurrentTranslucent(FallThrough[IMDataStructureTranslucent]):
    ...
    def _process_candidate(cls, c: Any, d: IMDataStructureTranslucent, queue=None, ev=None, parameters: Optional[Dict[str, Any]] = None):
        ...
        cut = cls._find_cut(IMDataStructureTranslucent(l_alt, d.log), ev, parameters=parameters)
