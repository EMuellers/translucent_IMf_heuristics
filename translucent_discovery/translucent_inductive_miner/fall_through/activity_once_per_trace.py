...
from translucent_discovery.translucent_inductive_miner.fall_through.activity_concurrent import ActivityConcurrentTranslucent, ActivityConcurrentTranslucentTCL
...
class ActivityOncePerTraceTranslucentTCL(ActivityConcurrentTranslucentTCL):
