...
class LoopCutTranslucent(LoopCut[IMDataStructureTranslucent]):
...
class LoopCutTranslucentTCL(LoopCut[IMDataStructureTranslucent]):
    ...
    def project(
        cls,
        obj: IMDataStructureTranslucent,
        groups: List[Collection[Any]],
        parameters: Optional[Dict[str, Any]] = None,
    ) -> List[IMDataStructureTranslucent]:
        """
        ...
        return [IMDataStructureTranslucent(None, l, obj.log, frequent=obj.frequent, parameters=parameters) for l in logs]
    ...
    def _append_trace_to_redo_log(
        ...
        if not redo_logs:
            return redo_logs
        activities = set(e[0] for e in redo_trace)
