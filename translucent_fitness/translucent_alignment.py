...
from translucent_fitness.translucent_reachability_graph import TranslucentReachabilityGraph, TranslucentAlignmentStateGraph


def align(translucent_trace: Trace, translucent_reachability_graph: TranslucentReachabilityGraph, inverse_trg, ignore_translucent: bool = False):
    ...
    return TranslucentAlignmentStateGraph(translucent_reachability_graph, translucent_trace).get_optimal_alignment(inverse_trg, ignore_translucent=ignore_translucent)
