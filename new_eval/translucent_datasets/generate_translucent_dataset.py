...
if __name__ == "__main__":
    dataset_paths = []
    dataset_paths.append(("/home/eliasmullers/Desktop/thesis/TranslucentActivityRelationships-main/new_eval/original_datasets/Sepsis Cases - Event Log.xes.gz",'Sepsis'))
    dataset_paths.append(("/home/eliasmullers/Desktop/thesis/TranslucentActivityRelationships-main/new_eval/original_datasets/Road_Traffic_Fine_Management_Process.xes.gz", 'road_traffic_fine'))
    dataset_paths.append(("/home/eliasmullers/Desktop/thesis/TranslucentActivityRelationships-main/new_eval/original_datasets/Hospital Billing - Event Log.xes.gz", 'hospital_billing'))
    if os.name == 'nt': # Windows
    ...
    #dataset_names=['Sepsis', 'road_traffic_fine', 'hospital_billing']
    input_log_path = False
    model_noise_threshold_list=[0.4]
    ...
    for dataset_path, dataset_name in dataset_paths:
        for model_noise_threshold in model_noise_threshold_list:
            if not input_log_path:
                pnml_path = f"/home/eliasmullers/Desktop/thesis/TranslucentActivityRelationships-main/new_eval/translucent_datasets/{dataset_name}/{dataset_name}_{model_noise_threshold}_ground_truth.pnml"
